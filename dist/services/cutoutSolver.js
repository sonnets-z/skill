...
exports.CutoutSolutionSelector = void 0;
class CutoutSolutionSelector {
    selectSolution(analysis) {
        let primaryTechnique = 'pen_tool';
        let secondaryTechniques = [];
        let reason = '';
        let confidence = 0.8;
        const { productType, hasModel, hasHair, hasTransparentMaterial, isWhiteBackground, backgroundComplexity, subjectComplexity } = analysis;
        if (hasHair) {
...
exports.CutoutSolutionSelector = CutoutSolutionSelector;
